...
from bokeh.models.widgets import CheckboxGroup, Slider, RangeSlider, CheckboxButtonGroup, Tabs
...
def density_tab(flights):
	...
	def make_dataset(carrier_list, range_start, range_end, bandwidth):
		...
		new_src = ColumnDataSource(data={'x': xs, 
		                                 'y': ys, 
										 'color': colors, 
										 'label': labels})
		return new_src
...
def modify_doc(doc) :
	...
	tabs = Tabs(tabs = [density_tab(flights)])
