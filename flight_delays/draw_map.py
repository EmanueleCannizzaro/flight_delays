...
from bokeh.models.widgets import CheckboxGroup, CheckboxButtonGroup, Tabs
...
def map_tab(map_data, states):
	...
	def make_dataset(carrier_list):
		...
		#color_dict = {carrier: color for carrier, color in zip(subset), Category20_16)}
	...
	available_carriers = sorted(set(map_data['carrier']['Unnamed: 3_level_1']))
...
if __name__ == 'main' :
	...
	tabs = Tabs(tabs=map_tab(map_data, states))
	doc.add_root(tabs)
